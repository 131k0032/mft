...
<html>
  <head>
	...
	<title>Wedding Planner Transfers - <?php echo $VAR_CIA ?></title>
		...
		<div class="wrap">
			<div class="row">
				...
				<div class="content three-fourth textongrey">
					...
					<p class="lead" style="text-align:justify">Dear Wedding Planner</p>
					<p class=""  style="text-align:justify">
                            Need Transfers or transportation services?
					...
					<form method="post" action="contact_form_message.php" name="contactform" id="contactform">
						...
						<div class="f-row">
							<div class="full-width">
								...
								<textarea id="comments" name="comments" required placeholder="Hi, I'm thinking of getting married but I need transportation in the Mayan Riviera. Can you give me more information?"></textarea>
							</div>
						</div>
						<div class="f-row">
