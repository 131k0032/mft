		...
		<div class="wrap">
			<div class="row">
                ...
                <?php if($_COOKIE["txtdate2"] != "" ){   ?>
						...
						<div class="f-row">
							<div class="one-fourth">From</div>
							<div class="three-fourth"><?php echo $_COOKIE["txtorig2"] ?></div>
						</div>
						<div class="f-row">
							<div class="one-fourth">To</div>
							<div class="three-fourth"><?php echo $_COOKIE["txtdest2"] ?></div>
						</div>
                ...
                <?php  } ?>
						...
						<div class="actions">
							<a href="include-paso3.php"           class="btn medium back">Go back</a>
                            <a href="include-confirm.php"        class="btn medium color right">Confirm</a>
