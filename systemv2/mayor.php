...
?>
                                ...
                                <select class="form-control" onchange="document.formulario.submit()"  name="txtagen" >
                                  ...
                                  <option value="" <?php if($VAR_AGEN==""){echo "selected";}?> >Vacios</option>
                                    <?php
                                        ...
                                        $sqlf1= "select * from _clientes cli_nomb " ;
                                        $rsf1 = adoopenrecordset($sqlf1);
                                        while($rstempf1 = mysql_fetch_array($rsf1)){
                        ...
                        <div class="col-lg-12"><hr></div>
                            ...
                            <table width="100%" data-order='[[ 0, "desc" ]]' data-page-length='50' class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr> <th colspan="7"  style="text-align:center">DEL <?php echo $VAR_DEL ?>  AL <?php echo $VAR_AL ?>   </th>  </tr>
                                     <tr>
                                        <th></th>
                                        <th colspan="3" style="text-align:center" >Control total de Servicios</th>
                                        <th colspan="3" style="text-align:center" >Control de Facturación</th>

                                     </tr>

                                    <tr>
                                        <th style="text-align:center">Agencia</th>
                                        <th style="text-align:center">Total de Servicios</th>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">$ <?php echo number_format(total_de_servicios($rstemp["agen"],$VAR_DEL,$VAR_AL), 2)  ?></td>
                                        <td align="right">$ <?php echo number_format(   total_facturado($rstemp["agen"],$VAR_DEL,$VAR_AL), 2)  ?></td>
                                        <td align="right">$ <?php echo number_format(   total_por_facturar($rstemp["agen"],$VAR_DEL,$VAR_AL), 2)  ?></td>
                                        <td align="right">$ <?php     $VAR_FACTURADO= total_facturado($rstemp["agen"],$VAR_DEL,$VAR_AL) ; echo number_format(  $VAR_FACTURADO, 2)  ?></td>
                                        <td align="right">$ <?php     $VAR_PAGADO   =    total_pagado($rstemp["agen"],$VAR_DEL,$VAR_AL) ; echo number_format(  $VAR_PAGADO, 2)  ?></td>
                                        <td align="right">$ <?php echo number_format( $VAR_FACTURADO-$VAR_PAGADO  , 2)  ?></td>
