                                ...
                                //      if(isset($_GET["mes"])){ $sqlf= $sqlf." and date1 like  '%".$_GET["mes"]."%' " ; $VAR_TITLE =  "ORDENES MES ".$_GET["mes"];}
                                    ...
                                    if(isset($_POST["txtfiltro"])){
                                        ...
                                        $sqlf= $sqlf." and (name like('%".$_POST["txtfiltro"]."%')
                                                       ...
                                                       or pro_nomb  like('%".$_POST["txtfiltro"]."%')
                                                       or usuario  like('%".$_POST["txtfiltro"]."%')
                                                       or mobile  like('%".$_POST["txtfiltro"]."%')
                                    ...
                                    $sqlf= $sqlf." and date1 <= '".$VAR_AL."'";
                                      ...
                                      if(isset($_POST["txtpro"]))   { if($_POST["txtpro"]!="Todos"){  $VAR_PRO = $_POST["txtpro"];  $sqlf= $sqlf." and pro_nomb = '".$VAR_PRO."'";   } }
                        ...
                        <form method="post"  id="formulario" name="formulario">
                            ...
                            <div class="col-lg-3" >
                                ...
                                <select class="form-control"  name="txtpro" >
                                    <option>Todos</option>
                                    <?php
                                        $sqlf1= "select * from _proveedores where pro_nomb <> '' group by pro_nomb order by pro_nomb" ;
                                        $rsf1 = adoopenrecordset($sqlf1);
                                        while($rstempf1 = mysql_fetch_array($rsf1)){
                                         if(isset($_POST["txtpro"])){ if($VAR_PRO==$rstempf1["pro_nomb"]){$VAR_XX = "selected";}else{$VAR_XX="";}}
                           ...
                           <div class="col-lg-12" >
                                <form method="post" action="impresion.php" target="_blank" >
                                ...
                                <tbody>
                                    <?php
                                      ...
                                      ?>
                                        ...
                                        <!--     <td><?php echo substr($rstempf["num"],-5) ?></td>    -->
                                         <!--   <td><?php echo date("Y-m-d",$rstempf["num"]) ?></td> -->
                                            ...
                                            <td><?php echo strtoupper($rstempf["oper"]) ?></td>
                                            <td><?php echo strtoupper($rstempf["agen"]) ?></td>
                                            <td><?php echo strtoupper($rstempf["pro_nomb"]) ?></td>
                                            <td><?php echo strtoupper($rstempf["usuario"]) ?></td>
